// src/lib.rs
/*
 * Core library for LoyaltyProgram
 */
...
#[derive(Debug)]
pub struct LoyaltyProgramProcessor {
    verbose: bool,
    processed_count: usize,
}

impl LoyaltyProgramProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting LoyaltyProgram processing");
    
    let mut processor = LoyaltyProgramProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = LoyaltyProgramProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = LoyaltyProgramProcessor::new(false);
